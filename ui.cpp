...
#define GOOD_FONT_SIZE 16.f
#define SMALL_FONT_QUALITY FONT_QUALITY_12
#define SMALL_FONT_SIZE 12.f
...
#include "Shaders/uiShader.glsl"
    ...
    glGenVertexArrays(1, &uiletter_vao);
...
void cleanupUIThing(){
    ...
    glDeleteVertexArrays(1, &uiletter_vao);
